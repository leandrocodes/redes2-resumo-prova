...
O processamento na porta de entrada começa pela terminação de linha, em seguida é efetuado o processamento de enlace, logo após a consulta e o
...
Nessa abordagem, as portas de entrada transferem um pacote diretamente para a porta de saída por um barramento compartilhado sem a intervenção
do processador de roteamento. No entanto, somente um pacote por vez pode ser transferido.
